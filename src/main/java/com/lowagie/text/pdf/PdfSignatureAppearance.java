...
public class PdfSignatureAppearance {
	 ...
	 * <CODE>SignatureRenderGraphicAndDescription</CODE>. The two last modes should
	 * be used with Acrobat 6 layer type.
	 * 
	 ...
	 * 
	 * @param signatureGraphic image rendered. If <CODE>null</CODE> the mode is
	 *                         defaulted to <CODE>SignatureRenderDescription</CODE>
	 */
	 ...
	 * 
	 * @param text the signature text identifying the signer. If <CODE>null</CODE>
	 ...
	 * 
	 * @param text the text identifying the signature status. If <CODE>null</CODE>
	 ...
	 * @param filter    the crytographic filter type. It can be SELF_SIGNED,
	...
	/**
	 * Sets the signature to be visible. An empty signature field with the same name
	 * must already exist.
	 * 
	 ...
	 * <p>
	 * Consult
	 * <A HREF= "http://partners.adobe.com/asn/developer/pdfs/tn/PPKAppearances.pdf"
	...
	/**
	 * Gets the template that aggregates all appearance layers. This corresponds to
	 * the /FRM resource.
	 * <p>
	 * Consult
	 * <A HREF= "http://partners.adobe.com/asn/developer/pdfs/tn/PPKAppearances.pdf"
	...
	public PdfTemplate getAppearance() throws DocumentException {
		...
		if (app[2] == null) {
			...
			if (layer2Text == null) {
				...
				buf.append("Firmado electronicamente por ")
			...
			if (render == SignatureRenderNameAndDescription) {
				...
				// must calculate the point to draw from to make image appear in middle of
				// column
				float x = 0;
				// experimentation found this magic number to counteract Adobe's signature
				// graphic, which
	...
	/**
	 * Gets the rectangle that represent the position and dimension of the signature
	 * in the page.
	 * 
	 ...
	 * 
	 * @return the temporary file or <CODE>null</CODE> is the document is created in
	 *         memory
	 */
	 ...
	 * byte_size*2+2.
	 * 
	 * @param exclusionSizes a <CODE>Map</CODE> with names and sizes to be excluded
	 *                       in the signature calculation. The key is a
	 *                       <CODE>PdfName</CODE> and the value an
	 *                       <CODE>Integer</CODE>. At least the
	 ...
	 * 
	 * @param update a <CODE>PdfDictionary</CODE> with the key/value that will fill
	...
	/**
	 * Gets the document bytes that are hashable when using external signatures. The
	 * general sequence is: preClose(), getRangeStream() and close().
	 * <p>
	 * 
	...
	/**
	 * Gets the instance of the standard signature dictionary. This instance is only
	 * available after pre close.
	 * <p>
	...
	/**
	 * Acrobat 6.0 and higher recommends that only layer n2 and n4 be present. This
	 * method sets that mode.
	 * 
	 * @param acro6Layers if <code>true</code> only the layers n2 and n4 will be
	 *                    present
	 */
