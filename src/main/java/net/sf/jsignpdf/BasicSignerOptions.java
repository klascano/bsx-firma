...
//  private final static Logger LOGGER = Logger.getLogger(BasicSignerOptions.class);
	...
	private InputStream isKsFile;
	private byte[] image;
	private byte[] bgImage;
	private InputStream isInFile;
	private OutputStream osOutFile;
	...
	public InputStream getIsKsFile() {
		return isKsFile;
	}

	public void setIsKsFile(InputStream isKsFile) {
		this.isKsFile = isKsFile;
	}

	public InputStream getIsInFile() {
		return isInFile;
	}

	public void setIsInFile(InputStream isInFile) {
		this.isInFile = isInFile;
	}

	public OutputStream getOsOutFile() {
		return osOutFile;
	}

	public void setOsOutFile(OutputStream osOutFile) {
		this.osOutFile = osOutFile;
	}
