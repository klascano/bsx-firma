...
public class Constants {
	...
	/**
	 * Home directory of current user. It's not a real constant it only holds value
	 * of <code>System.getProperty("user.home")</code>
	 */
	...
	public static final String L2TEXT_FONT_PATH = "/net/sf/jsignpdf/fonts/Helvetica.ttf";
	public static final String L2TEXT_FONT_NAME = "Helvetica.ttf";
	...
	public static final String PDF2IMAGE_LIBRARIES = ConfigProvider.getInstance()
			.getNotEmptyProperty("pdf2image.libraries", PDF2IMAGE_LIBRARIES_DEFAULT);

	public static final String DEFVAL_TSA_HASH_ALG = ConfigProvider.getInstance()
			.getNotEmptyProperty("tsa.hashAlgorithm", "SHA-1");
