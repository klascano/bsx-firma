...
public class FontUtils {
	...
	private final static Logger LOGGER = Logger.getLogger(FontUtils.class);
		...
		if (l2baseFont == null) {
			...
			try {
				...
				if (System.getProperty("os.name").toLowerCase().contains("windows")) {
					...
					LOGGER.info("Using tailored windows font");
					Font font = FontFactory.getFont("c:/windows/fonts/arial.ttf", BaseFont.WINANSI, BaseFont.EMBEDDED,
							Constants.DEFVAL_L2_FONT_SIZE, Font.NORMAL, Color.BLACK);
					l2baseFont = font.getBaseFont();
