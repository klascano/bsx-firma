...
public class KeyStoreUtils {
	...
	public static KeyStore loadKeyStore(String aKsType, final InputStream aKsFile, final char[] aKsPasswd) {
		if (StringUtils.isEmpty(aKsType) && aKsFile == null) {
	...
	public static KeyStore loadKeyStore(String aKsType, final String aKsFile, final char[] aKsPasswd) {
		...
		return loadKeyStore(aKsType, tmpIS, aKsPasswd);
	}
	...
	KeyStoreException, NoSuchAlgorithmException {
		KeyStore tmpKs = null;
		if(options.getIsKsFile() == null)
			tmpKs = loadKeyStore(options.getKsType(), options.getKsFile(), options.getKsPasswd());
		else
			tmpKs = loadKeyStore(options.getKsType(), options.getIsKsFile(), options.getKsPasswd());
